...
/* package */ class ConcreteTable implements Table {
	...
	public final static class Test {
		...
		Table pet = TableFactory.create("people", new String[] { "dog", "cat", "dolpin", "tutle" });
...
//				/* Failed correctly, do nothing */ }
		...
		public void testStore() throws IOException, ClassNotFoundException { // Flush the table to disk, then reread it.
			...
			Writer out3 = new FileWriter("people.xml");
			people.export(new XMLExporter(out3));
			out3.close();
			...
			Reader in2 = new FileReader("people.xml");
			Table people2 = new ConcreteTable(new XMLImporter(in2));
			in2.close();
		}
